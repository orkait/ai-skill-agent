# React Flow v12 - Production Store and Editor Shell Architecture

> Source extraction from the provided reference bundle. Focused on production state management and editor shell structure.
...
type ActionNodeData = { label: string; action: string; config: Record<string, unknown> };
