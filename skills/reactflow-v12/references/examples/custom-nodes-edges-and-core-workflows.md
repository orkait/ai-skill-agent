# React Flow v12 - Custom Nodes, Edges, and Core Workflow Examples

> Source extraction from the provided reference bundle. Includes typed custom nodes/edges, interaction patterns, serialization, dark mode, and computing flows.

## Custom Nodes (v12 Pattern)
...
// ✅ v12: Define node type for type safety
export type ActionNodeType = Node<ActionNodeData, 'action'>;

// ✅ v12: Use NodeProps<YourNodeType> for typed props
...
const onDrop = useCallback(
  (event: React.DragEvent) => {
    ...
    // ✅ v12: Use screenToFlowPosition (NOT project)
...
```tsx
// ✅ v12: Use toObject() from useReactFlow
...
## Dark Mode (v12 Built-in)

```tsx
// ✅ v12 native dark mode via colorMode prop
<ReactFlow
