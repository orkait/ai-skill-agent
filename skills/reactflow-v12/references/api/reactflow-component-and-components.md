# React Flow v12 — Complete API Reference
...
| `onMove` | `OnMove` | During viewport move (now also fires for programmatic moves like fitView) |
  ...
  return (
    <>
      ...
      <EdgeLabelRenderer>
        ...
        >
          <span className="rounded bg-white px-2 py-1 text-xs shadow">Label</span>
        </div>
      </EdgeLabelRenderer>
    </>
  );
